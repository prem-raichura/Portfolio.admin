      ...
      {projectToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-[32px] border border-[var(--border-color)] bg-[var(--bg-main)] p-6 shadow-2xl">
            <h3 className="text-xl font-bold">Move Project to Bin?</h3>
            <p className="mt-2 text-[var(--text-secondary)]">
              "{projectToDelete.title}" will be moved to the Bin. You can restore it for 30 days before it's permanently deleted.
            </p>
